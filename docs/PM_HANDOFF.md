...
- ui: U4 AI с trace, U5 Парето/Таймлайн, E5/U7 карта; только скриншоты в docs/screenshots/. U8 и README целиком принадлежат engine. U6/R1 тоже engine; R2 репетиция общая.
...
E6 уже cut. Порядок урезания: таймлайн → Парето → карта. Если E4 не готов к 16:20 — оставляем только Парето. README U8 делает engine к 17:45; ui добавляет только скриншоты. Агент, README, Docker не режем.
