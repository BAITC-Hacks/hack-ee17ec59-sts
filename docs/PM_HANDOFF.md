...
Синк 2:40, интеграция 3:30, фриз 4:30. START=14:00 сохранён в docs/status/META.md; PM нужно подтвердить владельцев ai/ui вместо «Игрок 2/3». Распределить будущие задачи по реальным путям из AGENTS.md.
...
Порядок урезания: E6 → таймлайн → Парето → карта. Агент, README, Docker не режем.
