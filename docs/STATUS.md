...
- `npm run status`: Node без внешних зависимостей, зоны engine/ai/ui; 26 уникальных тикетов, 13 done (50.0%).
...
## Следующие задачи
- engine: E3/E4 done; дальше E5 react-leaflet. AI/UI подключают готовые tools: src/lib/simulation/index.ts.
