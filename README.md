...
Выбор пяти инициатив и районов.

![Конструктор городского сценария](docs/screenshots/main.png)

### Результаты

Эталонный сценарий: Score 56.54 при бюджете 95/100.

![Результаты эталонного сценария](docs/screenshots/results.png)

### Карта районов

Изменение районных баллов после выбранных инициатив.

![Изменения на карте районов Астаны](docs/screenshots/map.png)

### Парето

Сравнение текущего плана с лучшими сценариями при разных бюджетах.

![Сравнение сценария с фронтом Парето](docs/screenshots/pareto.png)

### AI-советник

Вопросы и резервный разбор сценария по расчётам движка. На этом снимке показан режим fallback.

![AI-советник в резервном режиме](docs/screenshots/ai.png)

### Журнал инструментов

Вызовы инструментов с аргументами и результатами расчётов.

![Журнал вызовов инструментов AI-советника](docs/screenshots/ai-trace.png)
...
Последний полный прогон приложения: **127 тестов в 9 файлах**, lint и production build прошли. Проверяются baseline, эталон и невалидные сценарии, оптимизатор, ограничения, рейтинг, Парето, timeline, API и fallback, применение советов, форматирование записки, каталог названий для агента и геоданные. Пользовательский путь «эталон → совет → применить → отменить» также проверен вручную.
